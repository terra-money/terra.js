...
> {
    ...
    public toAmino(legacy?: boolean): InstantiateContractProposal.Amino {
    ...
    public toProto(legacy?: boolean): InstantiateContractProposal.Proto {
        const { title, description, run_as, admin, code_id, init_msg, init_coins, label } = this;
        if (legacy) {
            throw new Error('Not supported for the network')
        }
    ...
    public packAny(legacy?: boolean): Any {
        ...
        return Any.fromPartial({
            ...
            value: InstantiateContractProposal_pb.encode(this.toProto(legacy)).finish(),
        });
    }

    public static unpackAny(msgAny: Any, legacy?: boolean): InstantiateContractProposal {
        if (legacy) {
            throw new Error('Not supported for the network')
        }
        return InstantiateContractProposal.fromProto(
            InstantiateContractProposal_pb.decode(msgAny.value), legacy
        );
    }
    ...
    public toData(legacy?: boolean): InstantiateContractProposal.Data {
