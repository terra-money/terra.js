...
> {
    ...
    public static fromAmino(data: UpdateAdminProposal.Amino, legacy?: boolean): UpdateAdminProposal {
        if (legacy) {
    ...
    public toAmino(legacy?: boolean): UpdateAdminProposal.Amino {
        if (legacy) {
            throw new Error('Not supported for the network');
        }
    ...
    public static fromProto(proto: UpdateAdminProposal.Proto, legacy?: boolean): UpdateAdminProposal {
        if (legacy) {
            throw new Error('Not supported for the network');
        }
        return new UpdateAdminProposal(
    ...
    public toProto(legacy?: boolean): UpdateAdminProposal.Proto {
        if (legacy) {
            throw new Error('Not supported for the network');
        }
        const { title, description, contract, new_admin } = this;
    ...
    public packAny(legacy?: boolean): Any {
        ...
        return Any.fromPartial({
            ...
            value: UpdateAdminProposal_pb.encode(this.toProto(legacy)).finish(),
        });
    }

    public static unpackAny(msgAny: Any, legacy?: boolean): UpdateAdminProposal {
        if (legacy) {
            throw new Error('Not supported for the network');
        }
    ...
    public static fromData(data: UpdateAdminProposal.Data, legacy?: boolean): UpdateAdminProposal {
        if (legacy) {
            throw new Error('Not supported for the network');
        }
        const { title, description, contract, new_admin } = data as UpdateAdminProposal.Data;
        return new UpdateAdminProposal(
            title,
            description,
            contract,
    ...
    public toData(legacy?: boolean): UpdateAdminProposal.Data {
        if (legacy) {
            throw new Error('Not supported for the network');
        }
        const { title, description, contract, new_admin } = this;
