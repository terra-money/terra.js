...
> {
    ...
    public static fromAmino(data: SudoContractProposal.Amino, legacy?: boolean): SudoContractProposal {
        if (legacy) {
    ...
    public toAmino(legacy?: boolean): SudoContractProposal.Amino {
        if (legacy) {
            throw new Error('Not supported for the network');
        }
    ...
    public static fromProto(proto: SudoContractProposal.Proto, legacy?: boolean): SudoContractProposal {
        if (legacy) {
            throw new Error('Not supported for the network');
        }
        return new SudoContractProposal(
    ...
    public toProto(legacy?: boolean): SudoContractProposal.Proto {
        if (legacy) {
            throw new Error('Not supported for the network');
        }
        const { title, description, contract, msg } = this;
    ...
    public packAny(legacy?: boolean): Any {
        ...
        return Any.fromPartial({
            ...
            value: SudoContractProposal_pb.encode(this.toProto(legacy)).finish(),
        });
    }

    public static unpackAny(msgAny: Any, legacy?: boolean): SudoContractProposal {
        if (legacy) {
            throw new Error('Not supported for the network');
        }
    ...
    public static fromData(data: SudoContractProposal.Data, legacy?: boolean): SudoContractProposal {
        if (legacy) {
            throw new Error('Not supported for the network');
        }
        const { title, description, contract, msg } = data as SudoContractProposal.Data;
        return new SudoContractProposal(
            title,
            description,
            contract,
    ...
    public toData(legacy?: boolean): SudoContractProposal.Data {
        if (legacy) {
            throw new Error('Not supported for the network');
        }
        const { title, description, contract, msg } = this;
