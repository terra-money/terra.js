...
describe('ParameterChangeProposal', () => {
  const pcpJSON2: ParameterChangeProposal.Amino = {
  ...
  it('parses StdTx parameter change proposals', () => {
    expect(ParameterChangeProposal.fromAmino(pcpJSON2)).toBeTruthy();
  });
});
// import { ParameterChangeProposal } from './ParameterChangeProposal';
...
// describe('ParameterChangeProposal', () => {
//   it('parses StdTx parameter change proposals', () => {
//     ParameterChangeProposal.fromAmino(pcpJSON2);
//   });
...
//     expect(ParameterChangeProposal.fromAmino(p.toAmino())).toEqual(p); // check that serialization / deserialization is consistent
//     // check that output is consistent with Jigu's
//     expect(p.toAmino()).toMatchObject(jiguJSON);
//   });
// });
