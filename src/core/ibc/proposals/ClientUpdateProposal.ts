...
> {
  ...
  public static fromAmino(data: ClientUpdateProposal.Amino) {
    const {
  ...
  public static fromData(data: ClientUpdateProposal.Data) {
  ...
  public static fromProto(proto: ClientUpdateProposal.Proto) {
    return new ClientUpdateProposal(
      proto.title,
      proto.description,
