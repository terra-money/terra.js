...
> {
  ...
  public static fromAmino(data: MsgRegisterCounterpartyPayee.Amino) {
    const {
      value: { port_id, channel_id, relayer, counterparty_payee },
    } = data;
  ...
  public toAmino(): MsgRegisterCounterpartyPayee.Amino {
