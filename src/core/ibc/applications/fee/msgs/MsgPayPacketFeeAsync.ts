...
> {
    ...
    public static fromAmino(_: any, legacy?: boolean): any {
        if (legacy) {
    ...
    public static fromData(data: MsgPayPacketFeeAsync.Data, legacy?: boolean): MsgPayPacketFeeAsync {
        if (legacy) {
            throw new Error('Net supported for the network')
        }
    ...
    public toData(legacy?: boolean): MsgPayPacketFeeAsync.Data {
        if (legacy) {
            throw new Error('Net supported for the network')
        }
    ...
    public static fromProto(proto: MsgPayPacketFeeAsync.Proto, legacy?: boolean): MsgPayPacketFeeAsync {
        if (legacy) {
            throw new Error('Net supported for the network')
        }
        return new MsgPayPacketFeeAsync(
    ...
    public toProto(legacy?: boolean): MsgPayPacketFeeAsync.Proto {
        if (legacy) {
            throw new Error('Net supported for the network')
        }
    ...
    public packAny(legacy?: boolean): Any {
        ...
        return Any.fromPartial({
            ...
            value: MsgPayPacketFeeAsync_pb.encode(this.toProto(legacy)).finish(),
        });
    }

    public static unpackAny(msgAny: Any, legacy?: boolean): MsgPayPacketFeeAsync {
        if (legacy) {
            throw new Error('Net supported for the network')
        }
        return MsgPayPacketFeeAsync.fromProto(MsgPayPacketFeeAsync_pb.decode(msgAny.value), legacy);
    }
}
