...
import {
  ...
  MsgSendTx,
  IbcInterchainAccountsMsg,
} from './ibc/applications/interchain-accounts';
...
export namespace Msg {
  ...
  export type Proto =
    ...
    | IbcChannelMsg.Proto
    | IbcFeeMsg.Proto
    | IbcInterchainAccountsMsg.Proto
    | CrisisMsg.Proto;
  ...
  export function fromAmino(data: Msg.Amino): Msg {
    switch (data.type) {
      ...
      case 'wasm/MsgUpdateContractAdmin': // legacy (classic terra)
        return MsgUpdateAdmin.fromAmino(data);
      case 'wasm/MsgClearAdmin':
      case 'wasm/MsgClearContractAdmin': // legacy (classic terra)
      ...
      // ibc-fee
      case 'cosmos-sdk/MsgPayPacketFee':
        return MsgPayPacketFee.fromAmino(data);
      case 'cosmos-sdk/MsgPayPacketFeeAsync':
        return MsgPayPacketFeeAsync.fromAmino(data);
      case 'cosmos-sdk/MsgRegisterCounterpartyPayee':
        return MsgRegisterCounterpartyPayee.fromAmino(data);
      case 'cosmos-sdk/MsgRegisterPayee':
        return MsgRegisterPayee.fromAmino(data);
  ...
  export function fromData(data: Msg.Data): Msg {
    switch (data['@type']) {
      ...
      case '/ibc.applications.interchain_accounts.controller.v1.MsgRegisterInterchainAccount':
        return MsgRegisterInterchainAccount.fromData(data);
      case '/ibc.applications.interchain_accounts.controller.v1.MsgSendTx':
        return MsgSendTx.fromData(data);
  ...
  export function fromProto(proto: Any): Msg {
    switch (proto.typeUrl) {
      ...
      case '/terra.wasm.v1beta1.MsgUpdateAdmin':
      ...
      // ibc-interchain-accounts
      case '/ibc.applications.interchain_accounts.controller.v1.MsgRegisterInterchainAccount':
        return MsgRegisterInterchainAccount.unpackAny(proto);
      case '/ibc.applications.interchain_accounts.controller.v1.MsgSendTx':
        return MsgSendTx.unpackAny(proto);
