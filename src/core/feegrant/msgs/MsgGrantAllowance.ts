...
> {
  ...
  public static fromAmino(data: MsgGrantAllowance.Amino) {
    const {
  ...
  public static fromData(data: MsgGrantAllowance.Data) {
  ...
  public static fromProto(proto: MsgGrantAllowance.Proto) {
    return new MsgGrantAllowance(
      proto.granter,
      proto.grantee,
