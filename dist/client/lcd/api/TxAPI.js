...
var TxAPI = /** @class */ (function (_super) {
    ...
    TxAPI.prototype.estimateFee = function (tx, options) {
        return __awaiter(this, void 0, void 0, function () {
            var gasPrices, gasAdjustment, denoms, txValue, data;
            return __generator(this, function (_a) {
                ...
                denoms = options === null || options === void 0 ? void 0 : options.denoms;
                ...
                return [2 /*return*/, this.c
                        ...
                        if (denoms === undefined)
                            ...
                            return new core_1.StdFee(Number.parseInt(d.gas), core_1.Coins.fromData(d.fees).filter(function (c) { return denoms.includes(c.denom); }));
                    })];
            });
        });
    };
