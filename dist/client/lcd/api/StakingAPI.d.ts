...
export declare class StakingAPI extends BaseAPI {
     ...
     */
    delegations(delegator?: AccAddress, validator?: ValAddress): Promise<Delegation[]>;
    /**
     ...
     * @param validator validator's operator address
     */
    unbondingDelegations(delegator?: AccAddress, validator?: ValAddress): Promise<UnbondingDelegation[]>;
    /**
     ...
     */
    redelegations(delegator?: AccAddress, validatorSrc?: ValAddress, validatorDst?: ValAddress): Promise<Redelegation[]>;
    /**
     * Gets all bonded validators for a delegator given its address.
     * @param delegator delegator's account address
     */
    bondedValidators(delegator: AccAddress): Promise<Validator[]>;
    /**
     ...
     * @param validator validator's operator address
     */
    validator(validator: ValAddress): Promise<Validator>;
    /**
