...
var UpgradeAPI = /** @class */ (function (_super) {
    __extends(UpgradeAPI, _super);
    function UpgradeAPI(lcd) {
     ...
     */
    UpgradeAPI.prototype.appliedPlan = function (name, params) {
        if (params === void 0) { params = {}; }
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.c
                        .get("/cosmos/upgrade/v1beta1/applied_plan/".concat(name), params)
                        .then(function (d) { return Number.parseInt(d.height); })];
            });
        });
    };
    /**
     ...
     */
    UpgradeAPI.prototype.currentPlan = function (params) {
        if (params === void 0) { params = {}; }
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, this.c
                        ...
                        .then(function (d) { return (d.plan ? core_1.Plan.fromData(d.plan) : null); })];
            });
        });
    };
    /**
     ...
     */
    UpgradeAPI.prototype.moduleVersions = function (params) {
        if (params === void 0) { params = {}; }
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                if (this.lcd.config.isClassic) {
                ...
                return [2 /*return*/, this.c
                        ...
                        .then(function (d) {
                        return d.module_versions.map(function (mv) {
